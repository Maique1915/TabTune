  ...
  cyberpunk: {
    ...
    style: {
      ...
      fingers: {
        ...
        shadow: { enabled: true, color: "#00ff9d80", offsetX: 0, offsetY: 0, blur: 0 },
        opacity: 0.3
      },
      capo: {
        color: "#180220",
  ...
  midnight: {
    ...
    style: {
      ...
      fingers: {
        ...
        shadow: { enabled: true, color: "#3b82f660", offsetX: 0, offsetY: 0, blur: 0 },
        opacity: 0.9
      },
      capo: {
        color: "#1e293b",
  ...
  vintage: {
    ...
    style: {
      ...
      fingers: {
        ...
        shadow: { enabled: true, color: "#5c403350", offsetX: 0, offsetY: 0, blur: 0 },
        opacity: 0.9
      },
      capo: {
        color: "#5d4037",
...
interface SettingsPanelProps {
  ...
  numFrets?: number; // Needed to control carousel visibility
}
