...
import { STUDIO_PRESETS } from '@/components/shared/SettingsPanel';
            ...
            <div className="space-y-6">
                ...
                {activeUnifiedTab === 'chord' && (
                    <div className="space-y-6 animate-in slide-in-from-left-2 duration-300">
                        ...
                        {/* GLOBAL MODE: No Active Note Selected */}
                        {!editingNote && (
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <button
                                        onClick={() => onAddNote?.(activeMeasure?.id || '', activeDuration || 'q')}
                                ...
                                {/* Transposition Control - Current Measure */}
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                        ...
                        {/* CHORD MODE: Active Note Selected */}
                        {editingNote && (
                            <div className="space-y-6">
                                {/* Duration Selection */}
                                <div className="space-y-4">
