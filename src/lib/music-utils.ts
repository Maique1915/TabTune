...
/**
 * Calculates shifted tuning for down-tuning scenarios
 * @param baseTuning - Array of note names (e.g., ['E', 'A', 'D', 'G', 'B', 'e'])
 * @param shift - Number of semitones to shift (negative for down-tuning)
 * @returns Array of shifted note names
 */
