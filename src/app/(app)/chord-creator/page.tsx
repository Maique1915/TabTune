...
const ChordCreatorContent = () => {
    ...
    const [chordState, setChordState] = useState<ChordDiagramProps>({
        ...
        avoid: [],
        nut: { vis: false, str: [1, currentTuning.length], pos: 1, fin: 0, trn: 1 },
        origin: 4,
        unique: false,
    });
    ...
    return (
        <div className="flex flex-col h-screen bg-[#050505] overflow-hidden text-zinc-300">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                {/* Preview Area */}
                <div className="flex-1 relative flex flex-col items-center justify-center p-4 md:p-12 bg-[#080808]">
                    {isMobile && !isMenuOpen && (
                        <button
                    ...
                    <div className="w-full max-w-xl space-y-6 md:space-y-12 flex flex-col items-center">
                        <div className="flex flex-col items-center w-full">
                            <div className="p-4 md:p-12 rounded-3xl bg-zinc-950/50 border border-white/5 shadow-2xl backdrop-blur-sm">
