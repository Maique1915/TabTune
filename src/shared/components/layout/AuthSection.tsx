...
export function AuthSection({ variant = "header" }: AuthSectionProps) {
    ...
    const LanguageSelector = ({ align = "end" }: { align?: "start" | "end" | "center" }) => (
        <div className={`flex items-center gap-2 ${align === "end" ? "border-r pr-4 mr-2" : "border-l pl-4 ml-2"} border-white/10`}>
